<div align="center">
    <a href="https://umangashrestha.com.np"><h1 align="center">umangashrestha.com.np</h1></a>
...
```sh-session
git clone https://github.com/umanga907/umanga-portfolio.git
cd chronark.com
```


Create a `.env` file similar to [`.env.example`](https://github.com/umanga907/umanga-portfolio.git/blob/main/.env.example).
